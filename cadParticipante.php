                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <form class="form-horizontal form-label-left input_mask">
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" id="form-group-nome">
                                                    <input type="text" class="form-control has-feedback-left" id="nome" maxlength="50" placeholder="Nome">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                                    <button type="button" id="btnCadParticipante" class="btn btn-primary">Enviar</button>
                                                </div>
                                            </form>
                                        </div>
